...
#include "sys_pck1.h"  /*lint !e451 !e537 repeated include file */
    ...
    // *---------------------------------------------
    #define NUMOF_PE_SERVICES                       8  // number of supported PE services (in this example)
    ...
    #define PE_QUERY_ATTRIBUTES                     0x07    //modifier 0x00
    /*modifiers*/
    ...
    #define PE_MOD_QUERY_ATTRIBUTES                 0x00
    ...
    */
    ...
    // *---------------------------------------------
    #define NUMOF_PE_COMMANDS   8   // Number of supported PE commands (PE services)

    typedef ATTR_PNIO_PACKED_PRE struct
    {
       PNIO_UINT8       NumOfCmd;                 // number of supported PE commands
       #if ((NUMOF_PE_COMMANDS % 2) != 0)
            PNIO_UINT8       Cmd[NUMOF_PE_COMMANDS];     // list of supported PE commands, no padding
       #else
            PNIO_UINT8       Cmd[NUMOF_PE_COMMANDS + 1]; // list of supported PE commands + padding byte,
       #endif               //
    ...
    typedef ATTR_PNIO_PACKED_PRE struct 
    {
        PNIO_UINT8      major_version_number;
        PNIO_UINT8      minor_version_number;
        PNIO_UINT8      Entity_Class;
        PNIO_UINT8      Entity_Sub_Class;
        PNIO_UINT8      Dyn_T_and_E_values;
        PNIO_UINT8      Use_of_PE_ASE;
        PNIO_UINT32     Max_Command_Respond_Time;

    }  ATTR_PNIO_PACKED_PRE PE_SDR_RSP_QUERY_ATTRIBUTES;
