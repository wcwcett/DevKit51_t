...
#error "IOD_PDEV_NUMOF_PORTS macro is depreciated and replaced by IOD_CFG_PDEV_NUMOF_PORTS"
  ...
  * 0        : disable
  */
#define IOD_CFG_PU_FEATURES_SUPPORT     1
...
#if ((EXAMPL_DEV_CONFIG_VERSION == 2) || (MODULE_ID_DAP == 4))
...
/**
 * @brief maximum number of total ARs per device
 *
 *
 */
...
/**
 * @brief total maximum number of subslots (Modules+Head+Ports)
 *
 *
 */
#define IOD_CFG_MAX_NUMOF_SUBSLOTS              (IOD_CFG_MAX_SLOT_NUMBER + 2 + IOD_CFG_PDEV_NUMOF_PORTS)
...
/**
 * @brief macro switch for ProfiEnergy
 *
 */
#define IOD_ENABLE_PROFIENERGY    1
